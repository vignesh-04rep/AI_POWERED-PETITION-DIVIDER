...
def predict_for_user_input(df, user_complaint):
    ...
    return predicted_category, predicted_department, predicted_urgency
...
def main():
    ...
    # Get predictions
    predicted_category, predicted_department, predicted_urgency = predict_for_user_input(df, user_complaint)
